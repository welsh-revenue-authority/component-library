    ...
    template: `<WraExpansionPanel title='{{ args.title }}' aria-title='{{ args.aria-title }}' v-bind="args">
        <div>
          <p style="margin-block-start: 0px;">
            ...
            viverra nam libero justo laoreet. Vulputate odio ut enim blandit volutpat maecenas
            volutpat blandit aliquam. Facilisis gravida neque convallis a cras semper auctor.
            Pretium quam vulputate dignissim suspendisse in est ante. Aliquam purus sit amet
            luctus.
          </p>
          <p>
